...
TgLongPoll::TgLongPoll(const Api &api, const EventHandler* eventHandler, std::int32_t limit, std::int32_t timeout, const std::optional<std::vector<std::string>> &allowUpdates)
